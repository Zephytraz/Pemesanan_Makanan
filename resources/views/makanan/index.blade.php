...
<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid">
    @foreach ($data as $item)
        <div class="col">
            <div class="card">
                <img src="{{ asset('storage/uploads/'. $item->photo) }}" class="card-img-top" alt="..." style="width: 100%; height: 300px; object-fit: cover;">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mt-3 fs-6 justify-content-between">
                        ...
                        @else
                            <form action="{{route('makananfavorit.store')}}" method="post" style="display:inline;">
                                @csrf
                            ...
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#pembelian{{$item->id}}">
